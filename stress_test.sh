...
# Obtains information about the Asterisk version and hardware characteristics, as well as applying a 6-second delay to start the test in parity with freeswitch.
if [ "$web_notify_url_base" != "" ] && [ "$WEB_NOTIFY" = true ]; then

    # Get Asterisk version number only (e.g., 20.4.0)
